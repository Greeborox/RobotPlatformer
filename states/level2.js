Robot.level2 = {
  create: function() {
    ...
    this.levikula3 = Robot.createLewikula(game,928,928, this.pickUps);
    this.levikula4 = Robot.createLewikula(game,800,1152, this.pickUps);
    this.kopter1 = Robot.createKopter(game,296,80, this.pickUps,this.enemyShots);
  ...
  update: function() {
    ...
    this.plasmaShots.update(this.layer, this.doors, this.explosions);
